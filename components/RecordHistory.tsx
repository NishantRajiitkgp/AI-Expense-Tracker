...
const RecordHistory = async () => {
  ...
  if (error) {
    return (
      <div className='bg-gray-800/50 backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl border border-gray-700/50 transition-all duration-300'>
        ...
        <div className='bg-gradient-to-r from-red-900/20 to-pink-900/20 border-l-4 border-l-red-500 p-3 sm:p-4 rounded-xl'>
          ...
          <p className='text-red-400 ml-8 sm:ml-10 text-xs'>
            {error}
          </p>
        </div>
      </div>
  ...
  if (!records || records.length === 0) {
    return (
      <div className='bg-gray-800/50 backdrop-blur-sm p-4 sm:p-6 rounded-2xl shadow-xl border border-gray-700/50 transition-all duration-300'>
        <div className='flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6'>
          <div className='w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-xl flex items-center justify-center shadow-lg'>
            <span className='text-white text-sm sm:text-lg'>📝</span>
          </div>
          <div>
        ...
        <div className='text-center py-6 sm:py-8'>
          <div className='w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-indigo-900/50 to-indigo-800/50 rounded-2xl flex items-center justify-center mx-auto mb-4'>
